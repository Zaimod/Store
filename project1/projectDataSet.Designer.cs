...
namespace project1 {
    ...
    public partial class projectDataSet : global::System.Data.DataSet {
        ...
        public partial class productsDataTable : global::System.Data.TypedTableBase<productsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public productsRow AddproductsRow(int Id, string title, string description, double price, string image) {
...
namespace project1.projectDataSetTableAdapters {
    ...
    public partial class productsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [products] WHERE (([Id] = @Original_Id) AND ((@IsNull_title = 1 AND [title] IS NULL) OR ([title] = @Original_title)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_image = 1 AND [image] IS NULL) OR ([image] = @Original_image)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [products] ([Id], [title], [description], [price], [image]) VALUES (@" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [products] SET [Id] = @Id, [title] = @title, [description] = @description, [price] = @price, [image] = @image WHERE (([Id] = @Original_Id) AND ((@IsNull_title = 1 AND [title] IS NULL) OR ([title] = @Original_title)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_image = 1 AND [image] IS NULL) OR ([image] = @Original_image)));
SELECT Id, title, description, price, image FROM products WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, title, description, price, image FROM products";
        ...
        public virtual int Delete(int Original_Id, string Original_title, global::System.Nullable<double> Original_price, string Original_image) {
        ...
        public virtual int Insert(int Id, string title, string description, global::System.Nullable<double> price, string image) {
        ...
        public virtual int Update(int Id, string title, string description, global::System.Nullable<double> price, string image, int Original_Id, string Original_title, global::System.Nullable<double> Original_price, string Original_image) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string title, string description, global::System.Nullable<double> price, string image, int Original_Id, string Original_title, global::System.Nullable<double> Original_price, string Original_image) {
            return this.Update(Original_Id, title, description, price, image, Original_Id, Original_title, Original_price, Original_image);
        }
    }
